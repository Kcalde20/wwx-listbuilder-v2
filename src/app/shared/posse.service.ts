    ...
    constructor() {
        this.$PosseListSignal.set([
            ...
            },
            {
                ...
                relevantTraits: ['Lawmen', 'Automata', 'K9 Simulacra'],
            },
            {
                id: 'deadOrAlivePosse',
            ...
            },
            {
                ...
                relevantTraits: ['Lawmen', 'Deadly Seven'],
            },
            {
                ...
                relevantTraits: ['Lawmen', 'Agent', 'Union'],
            },
            {
                id: 'lynchMobPosse',
                ...
                relevantTraits: ['Lawmen', 'Automata'],
            },
            {
                ...
                relevantTraits: ['Lawmen', 'Ranger', 'Automata'],
            },
            {
                id: 'regulatorsPosse',
                ...
                relevantTraits: ['Lawmen', 'Regulators', 'Outlaw', 'K9 Simulacra'],
            },
            {
                ...
                relevantTraits: ['Lawmen', 'Tombstone', 'Automata'],
            },
            {
                ...
                relevantTraits: ['Lawmen', 'Mounted', 'K9 Simulacra'],
            },
            {
                ...
                relevantTraits: ['Lawmen', 'Wayward Eight'],
            },
        ]);
    }
}
